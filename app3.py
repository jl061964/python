...
def main():
    ...
    ax.bar(valores_vencidos.index, valores_vencidos["Vl.liquido"], label='Valores Vencidos', color='red')
    ax.bar(valores_a_vencer.index, valores_a_vencer["Vl.liquido"], label='Valores a Vencer', color='green', bottom=valores_vencidos["Vl.liquido"])
